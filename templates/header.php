            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php foreach ($categories->getAll() as $category): ?>
                                <li><a class="dropdown-item" href="category.php?name=<?php echo urlencode($category['name']); ?>"><?php echo htmlspecialchars($category['name']); ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                </ul>
                ...
                <a class="icon-link" href="cart.php">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" version="1.1" 
                         id="Capa_1" width="20px" height="20px" viewBox="0 0 902.86 902.86">
                        <g>
                            <g>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php if (isLoggedIn()): ?>
                                ...
                                <li><a class="dropdown-item" href="dashboard.php">Order History</a></li>
